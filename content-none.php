...
<section class="no-results not-found" itemscope="itemscope" itemtype="http://schema.org/Blog">
	<header class="page-header">
		<h1 class="page-title" itemprop="headline"><?php _e( 'Nothing Found', 'zerif-lite' ); ?></h1>
	</header><!-- .page-header -->
