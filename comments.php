...
<div id="comments" class="comments-area" itemscope itemtype="http://schema.org/UserComments">
	...
	<?php if ( have_comments() ) : ?>
		...
		<ul class="comment-list" itemprop="commentText">
		...
		<nav id="comment-nav-below" class="comment-navigation" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
